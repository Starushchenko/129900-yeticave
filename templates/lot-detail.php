    ...
    <section class="lot-item container">
        ...
        <div class="lot-item__content">
            ...
            <div class="lot-item__right">
                <?php if ($is_auth && !$bet_is_made && !$user_is_author && (strtotime($lot['finish_date'])) > strtotime('now')) : ?>
                ...
                <?php elseif ($is_auth && (strtotime($lot['finish_date'])) <= strtotime('now')) : ?>
                    <div class="lot-item__state">
                        <p>Аукцион окончен</p>
                        <?php if (isset($winner)) : ?>
